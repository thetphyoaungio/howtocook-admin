...
@Component({
    templateUrl:'./monthly-yearly-new-users.component.html',
    styleUrls:['./monthly-yearly-new-users.component.scss']
})
export class DateReportMonthlyYearlyNewUsersComponent implements OnInit, OnDestroy {
    reports:any;
    ...
    ngOnInit(): void {
        ...
        this.fileNameTxt = `date-report-${this.targetPeriod}-new-users`;
        this.thereIsNoTxt = `There is No ${this.targetPeriod==='monthly'?'Monthly':'Yearly'} New Users Report...`;
    }
    ...
    getReports() {
        ...
        this.reportService.getMonthlyNewUsers(qry) : 
        this.reportService.getYearlyNewUsers(qry);
    ...
    gotoNewUsersDetail(date:string) {
