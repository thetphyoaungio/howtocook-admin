...
export class ChefUsersPostDetailComponent implements OnInit, OnDestroy {
    postId:any;
    postDetail:any;
    ...
    constructor(
        ...
        this.route.params.subscribe({
            next:((params:any) => this.postId = params.id)
        });
    }
    ...
    backFromDetail(target:string) {
        if(target==='all-users') {
            ...
            this.router.navigate([`/${RouteNames.DASHBOARD}/${RouteNames.USERS}/${RouteNames.CHEF_USERS}/${RouteNames.CHEF_USERS_USER_DETAIL}`, this.postDetail.userId]);
        }
    }
